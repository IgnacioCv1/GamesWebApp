...
class Publisher:
    def __init__(self, publisher_name: str):
        ...
        self.__publisher_games = []
    @property
    def games(self):
        return self.__publisher_games
    ...
    def publisher_add_game(self, game):
        if isinstance(game, Game):
            self.__publisher_games.append(game)
...
class User:
    def __init__(self, username: str, password: str):
        ...
        self.__favorite_games: list[Game] = []
    ...
    def favorite_games(self):
        return self.__favorite_games

    def add_favourite_game(self, game):
        fav_games = self.favorite_games
        if not isinstance(game, Game) or game in fav_games:
            return
        self.favorite_games.append(game)

    def remove_favourite_game(self, game):
        if not isinstance(game, Game) or game not in self.favorite_games:
            return
